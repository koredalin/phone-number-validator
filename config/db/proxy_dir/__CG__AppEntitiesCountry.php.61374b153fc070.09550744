 ...
 */
class Country extends \App\Entities\Country implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Country' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Country' . "\0" . 'countryName', '' . "\0" . 'App\\Entities\\Country' . "\0" . 'iso3', '' . "\0" . 'App\\Entities\\Country' . "\0" . 'phoneCode'];
        }
