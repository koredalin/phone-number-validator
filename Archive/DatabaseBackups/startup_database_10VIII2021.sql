...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 10, 2021 at 10:35 AM
...
('MyProject\\Migrations\\Version20210810062104', '2021-08-10 08:59:50', 26),
('MyProject\\Migrations\\Version20210810062204', '2021-08-10 08:59:50', 560),
('MyProject\\Migrations\\Version20210810070009', '2021-08-10 09:13:13', 32);
...
CREATE TABLE `phone_confirmations` (
  ...
  `confirmation_code_message` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `phone_confirmation_attempts` (
  `id` bigint(20) NOT NULL,
  `phone_confirmation_id` bigint(20) DEFAULT NULL,
  `input_confirmation_code` int(11) NOT NULL,
  `status` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `transactions` (
  ...
  `confirmed_at` datetime DEFAULT NULL,
  `success_message` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
ALTER TABLE `phones`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_phone` (`country_id`,`phone_number`),
  ADD KEY `IDX_E3282EF5F92F3E70` (`country_id`);
...
ALTER TABLE `phone_confirmations`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_C5835DED2FC0CB0F` (`transaction_id`);
...
ALTER TABLE `phone_confirmation_attempts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_38042FC97064BDBF` (`phone_confirmation_id`);
...
ALTER TABLE `transactions`
  ...
  ADD KEY `IDX_EAA81A4C3B7323CB` (`phone_id`);
...
--
ALTER TABLE `phones`
  ADD CONSTRAINT `FK_E3282EF5F92F3E70` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`);

--
-- Constraints for table `phone_confirmations`
--
ALTER TABLE `phone_confirmations`
  ADD CONSTRAINT `FK_C5835DED2FC0CB0F` FOREIGN KEY (`transaction_id`) REFERENCES `transactions` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `phone_confirmation_attempts`
--
ALTER TABLE `phone_confirmation_attempts`
  ADD CONSTRAINT `FK_38042FC97064BDBF` FOREIGN KEY (`phone_confirmation_id`) REFERENCES `phone_confirmations` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `transactions`
--
ALTER TABLE `transactions`
  ADD CONSTRAINT `FK_EAA81A4C3B7323CB` FOREIGN KEY (`phone_id`) REFERENCES `phones` (`id`),
